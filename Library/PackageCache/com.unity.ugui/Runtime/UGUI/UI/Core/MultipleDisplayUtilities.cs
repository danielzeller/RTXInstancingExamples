...
namespace UnityEngine.UI
{
    internal static class MultipleDisplayUtilities
    {
        ...
        public static Vector3 RelativeMouseAtScaled(Vector2 position, int displayIndex)
        {
            ...
            // On Android with the new input system, passed positions are always relative to a surface and scaled accordingly to the rendering resolution.
            ...
            // Otherwise, on android in full screen, we add some padding if rendering and system resolution differs, as for other platforms' main display. (So behavior is unchanged for Android main display, untested for non-main displays)
#endif
